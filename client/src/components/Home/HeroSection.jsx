  ...
  return (
    <div className="hero-container">
      ...
      <div className="copy-container">
        <p>
          Discover a literary escape with Page Parcel – curated books delivered
          to you. Immerse in captivating tales, explore genres, and feed your
          reading passion. Your literary journey starts now.
        </p>
